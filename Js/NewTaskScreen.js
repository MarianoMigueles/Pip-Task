import { formatDateString, createTask, convertDateToISOString } from './main.js';
    ...
    main.innerHTML = `
        <section class="container left center-elements">
            <form id="new-task-screen" class="task-form center-elements">
                <input type="text" id="task-form-title" name="task-form-title" placeholder="Escribe tu titulo aquí...">
                <textarea id="task-form-input" placeholder="Escribe tu tarea aquí..."></textarea>
